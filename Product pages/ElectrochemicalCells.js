...
import BottleEchemCell from "../Images/BottleEchemCell.jpg"
import AcrylicFlatCell from "../Images/AcrylicFlatCell.jpg"
import BMSEchemCells from "../Images/BMSEchemCells.jpg"
import FlatCell from "../Images/FlatCell.jpg"
import JecketedElectrochemicalCell from "../Images/JecketedElectrochemicalCell.jpg"
import { NavLink } from "react-router-dom"
import { useState } from "react"



function ElectrochemicalCells () {
...
<div className="container">
    ...
    <h1 className="text-center" id="head" data-aos="fade-up" data-aos-duration="1500">Electrochemical Cells</h1> 
    <br></br>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="card h-100">
                <img src={BottleEchemCell} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">50ml Bottle Echem Cell / Code-1001</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={AcrylicFlatCell} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Acrylic Flat Cell / Code-1002</h2>
                </div>
            </div>
            </div>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={BMSEchemCells} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">BMS Echem Cells / Code-1003</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={FlatCell} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Flat Cell / Code-1004</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={JecketedElectrochemicalCell} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Jecketed Electro Chemical Cell / Code-1005</h2>
...
export default ElectrochemicalCells;