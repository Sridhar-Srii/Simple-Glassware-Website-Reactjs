...
import LtrsDistillation from "../Images/100LtrsDistillation.jpg"
import GlassReactionUnit from "../Images/GlassReactionUnit.jpg"
import RefluxReactionCumDistillationUnit from "../Images/RefluxReactionCumDistillationUnit.jpg"
import JacketedGlassReactor from "../Images/JacketedGlassReactor.jpg"
import Sheenlac from "../Images/Sheenlac.jpg"
import WA0001 from "../Images/WA0001.jpg"
import { useState } from "react"
import { NavLink } from "react-router-dom"


function DistillationPilotPlants() {
...
<div className="container">
    ...
    <h1 className="text-center" id="head" data-aos="fade-up" data-aos-duration="1500">Distillation Pilot Plants</h1> 
    <br></br>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="card h-100">
                <img src={LtrsDistillation} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">100 Ltrs Distillation / Code-1001</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={GlassReactionUnit} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Glass Reaction Unit / Code-1002</h2>
                </div>
            </div>
            </div>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={JacketedGlassReactor} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Jacketed Glass Reactor / Code-1003</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={Sheenlac} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Sheenlac / Code-1004</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={WA0001} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">WA0001 / Code-1005</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={RefluxReactionCumDistillationUnit} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Reflux Reaction Cum Distillation Unit / Code-1006</h2>
...
export default DistillationPilotPlants;