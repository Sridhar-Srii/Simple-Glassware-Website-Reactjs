...
import CO2PurityTester from "../Images/CO2PurityTester.jpg"
import GasAnalysisApparatus from "../Images/GasAnalysisApparatus.jpg"
import GasExtractorforTransformeroil from "../Images/GasExtractorforTransformeroil.jpg"
import OrsatTestWoodenCabinet from "../Images/OrsatTestWoodenCabinet.jpg"
import OxygenPurity from "../Images/OxygenPurity.jpg"
import { useState } from "react"



function OrsatGasPurityTesting () {
...
<div className="container">
    ...
    <h1 className="text-center" id="head" data-aos="fade-up" data-aos-duration="1500">Orsat & Gas Purity Testing Apparatus</h1>
    <br></br>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="card h-100">
                <img src={CO2PurityTester} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">CO2PurityTester / Code-1001</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={GasAnalysisApparatus} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Gas Analysis Apparatus / Code-1002</h2>
                </div>
            </div>
            </div>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={OxygenPurity} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Oxygen Purity / Code-1003</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={GasExtractorforTransformeroil} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Gas Extractor for Transformer oil / Code-1004</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={OrsatTestWoodenCabinet} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Orsat Test Wooden Cabinet / Code-1005</h2>
...
export default OrsatGasPurityTesting;