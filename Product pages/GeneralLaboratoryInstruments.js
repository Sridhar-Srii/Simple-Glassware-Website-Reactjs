...
import DensityMeasurementKit from "../Images/DensityMeasurementKit.jpg"
import AndreasenPipetteStand from "../Images/AndreasenPipetteStand.jpg"
import DeterminationofVolumetricExpansion from "../Images/DeterminationofVolumetricExpansion.jpg"
import HeadCrushTeaster from "../Images/HeadCrushTeaster.jpg"
import FordCupBrass from "../Images/FordCupBrass.jpg"
import { useState } from "react"
import { NavLink } from "react-router-dom"



function GeneralLaboratoryInstruments () {
...
<div className="container">
    ...
    <h1 className="text-center" id="head" data-aos="fade-up" data-aos-duration="1500">General Laboratory Instruments</h1> 
    <br></br>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="card h-100">
                <img src={DensityMeasurementKit} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Density Measurement Kit / Code-1001</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={AndreasenPipetteStand} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Andreasen Pipette Stand / Code-1002</h2>
                </div>
            </div>
            </div>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={DeterminationofVolumetricExpansion} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Determination of Volumetric Expansion  / Code-1003</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={HeadCrushTeaster} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">Head Crush Teaster / Code-1004</h2>
            ...
            <div class="col"  data-aos="fade-up" data-aos-duration="1500">
            <div class="card h-100">
                <img src={FordCupBrass} class="card-img-top" alt="..."></img>
                <div class="card-body">
                <h2 class="card-title text-center">FordCup Brass / Code-1005</h2>
...
export default GeneralLaboratoryInstruments ;